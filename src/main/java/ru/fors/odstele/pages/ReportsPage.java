...
public class ReportsPage{
	...
	By reportName = By.cssSelector(".main-table__item-second>div>h4>span"); //название в шапке отчета
	...
	public boolean isReportBuilds(){
		return CheckElementsTools.isElementPresent(driver, buildReportNameLocator);
	}
	...
	public void setPeriod(String period) {
		...
		CheckElementsTools.waitForAjaxIndicatorOff(driver, 10);
	}
